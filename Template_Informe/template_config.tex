...
\def\pagemarginbottom {1.95}%{2.7}        % Margen inferior página [cm]
\def\pagemarginleft {1}%{2.54}         % Margen izquierdo página [cm]
\def\pagemarginright {1}%{2.54}        % Margen derecho página [cm]
\def\pagemargintop {2.25}%{3}             % Margen superior página [cm]
